...
<b style="font-size: 30px;">𝓓𝓢𝓗 𝓗𝓸𝓽𝓮𝓵</b>
            ...
            <div class="navlink" style="font-size: 18px;">
                ...
                <ul id="menulist">
                        ...
                        <a class="btn btn-sm btn-dark rounded py-2 px-4"  href="../logout.php">Logout</a>
                ...
                </ul><div class="ul2" style="float:right">
                <ul>
                    <li class="menu-li">   
                        <div class="containerr">
                            <img src="ig/user.png" alt="Avatar" class="imagee"  >
                            <div class="overlayy">
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="room-item shadow rounded overflow-hidden">
                            <div class="position-relative">
                                <img class="img-fluid" src="ig/19.jpg" alt="">
